...
$client->setDeveloperKey('AIzaSyBP1HnG9Ga9CxCvBR_UEHpbUNm3JFzuL6Y'); //GET AT AT DEVELOPERS.GOOGLE.COM
...
//IT SAYS TO TREAT RECURRING EVENTS AS SINGLE EVENTS
    'singleEvents' => true,
    'orderBy' => 'startTime',
    'timeMin' => date('c'),//ONLY PULL EVENTS STARTING TODAY
...
?>">
        ...
        <?php echo $event->getSummary(); //SUMMARY = TITLE
