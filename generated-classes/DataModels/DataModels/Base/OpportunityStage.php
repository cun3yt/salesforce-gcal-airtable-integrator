 ...
 */
abstract class OpportunityStage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\DataModels\\DataModels\\Map\\OpportunityStageTableMap';
    ...
    /**
     * Initializes internal state of DataModels\DataModels\Base\OpportunityStage object.
     */
    ...
    /**
     * Compares this with another <code>OpportunityStage</code> instance.  If
     * <code>obj</code> is an instance of <code>OpportunityStage</code>, delegates to
     * <code>equals(OpportunityStage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OpportunityStage The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OpportunityStageTableMap::COL_ID] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[OpportunityStageTableMap::COL_CUSTOMER_ID] = true;
        }
    ...
    public function setStage($v)
    {
        ...
        if ($this->stage !== $v) {
            $this->stage = $v;
            $this->modifiedColumns[OpportunityStageTableMap::COL_STAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OpportunityStageTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOpportunityStageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OpportunityStage::setDeleted()
     * @see OpportunityStage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOpportunityStageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OpportunityStageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('opportunity_stage_id_seq')");
        ...
        if ($this->isColumnModified(OpportunityStageTableMap::COL_CUSTOMER_ID)) {
    ...
    {
        $pos = OpportunityStageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['OpportunityStage'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OpportunityStage'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DataModels\DataModels\OpportunityStage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DataModels\DataModels\OpportunityStage The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OpportunityStageTableMap::COL_CUSTOMER_ID)) {
            $criteria->add(OpportunityStageTableMap::COL_CUSTOMER_ID, $this->customer_id);
        }
        if ($this->isColumnModified(OpportunityStageTableMap::COL_STAGE)) {
    ...
    {
        $criteria = ChildOpportunityStageQuery::create();
        $criteria->add(OpportunityStageTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DataModels\DataModels\OpportunityStage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DataModels\DataModels\OpportunityStage Clone of current object.
     * @throws PropelException
     */
