...
class BuyerStageTableMap extends TableMap
{
     ...
     */
    const COL_CUSTOMER_ID = 'buyer_stage.customer_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(BuyerStageTableMap::COL_ID, BuyerStageTableMap::COL_CUSTOMER_ID, BuyerStageTableMap::COL_STAGE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(BuyerStageTableMap::COL_ID => 0, BuyerStageTableMap::COL_CUSTOMER_ID => 1, BuyerStageTableMap::COL_STAGE => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BuyerStageTableMap::COL_CUSTOMER_ID);
