 ...
 *
 * @method     ChildCustomerContactIntegrationQuery leftJoinCustomerContact($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomerContact relation
 * @method     ChildCustomerContactIntegrationQuery rightJoinCustomerContact($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomerContact relation
 * @method     ChildCustomerContactIntegrationQuery innerJoinCustomerContact($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomerContact relation
 *
 * @method     ChildCustomerContactIntegrationQuery joinWithCustomerContact($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the CustomerContact relation
 *
 * @method     ChildCustomerContactIntegrationQuery leftJoinWithCustomerContact() Adds a LEFT JOIN clause and with to the query using the CustomerContact relation
 * @method     ChildCustomerContactIntegrationQuery rightJoinWithCustomerContact() Adds a RIGHT JOIN clause and with to the query using the CustomerContact relation
 * @method     ChildCustomerContactIntegrationQuery innerJoinWithCustomerContact() Adds a INNER JOIN clause and with to the query using the CustomerContact relation
 *
...
abstract class CustomerContactIntegrationQuery extends ModelCriteria
{
     ...
     *
     * @param \DataModels\DataModels\CustomerContact|ObjectCollection $customerContact The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildCustomerContactIntegrationQuery The current query, for fluid interface
     */
    public function filterByCustomerContact($customerContact, $comparison = null)
    {
        if ($customerContact instanceof \DataModels\DataModels\CustomerContact) {
            return $this
                ->addUsingAlias(CustomerContactIntegrationTableMap::COL_CUSTOMER_CONTACT_ID, $customerContact->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CustomerContactIntegrationTableMap::COL_CUSTOMER_CONTACT_ID, $customerContact->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
