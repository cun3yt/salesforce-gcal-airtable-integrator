 ...
 */
abstract class MeetingHasAttendee implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\DataModels\\DataModels\\Map\\MeetingHasAttendeeTableMap';
    ...
    /**
     * The value for the meeting_attendee_id field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of DataModels\DataModels\Base\MeetingHasAttendee object.
     */
    ...
    /**
     * Compares this with another <code>MeetingHasAttendee</code> instance.  If
     * <code>obj</code> is an instance of <code>MeetingHasAttendee</code>, delegates to
     * <code>equals(MeetingHasAttendee)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MeetingHasAttendee The current object, for fluid interface
     */
    ...
    /**
     * Get the [meeting_attendee_id] column value.
     *
     * @return int
     */
    public function getMeetingAttendeeId()
    {
        return $this->meeting_attendee_id;
    }
    ...
    /**
     * Set the value of [meeting_attendee_id] column.
     *
     * @param int $v new value
     * @return $this|\DataModels\DataModels\MeetingHasAttendee The current object (for fluent API support)
     */
    public function setMeetingAttendeeId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->meeting_attendee_id !== $v) {
            $this->meeting_attendee_id = $v;
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = MeetingHasAttendeeTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMeetingHasAttendeeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MeetingHasAttendee::setDeleted()
     * @see MeetingHasAttendee::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMeetingHasAttendeeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MeetingHasAttendeeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO meeting_has_attendee (%s) VALUES (%s)',
    ...
    {
        $pos = MeetingHasAttendeeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DataModels\DataModels\MeetingHasAttendee
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DataModels\DataModels\MeetingHasAttendee The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DataModels\DataModels\MeetingHasAttendee (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DataModels\DataModels\MeetingHasAttendee Clone of current object.
     * @throws PropelException
     */
