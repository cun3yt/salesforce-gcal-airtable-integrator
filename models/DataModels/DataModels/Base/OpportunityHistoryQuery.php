 ...
 * @method     ChildOpportunityHistoryQuery orderByUserAccountId($order = Criteria::ASC) Order by the user_account_id column
 * @method     ChildOpportunityHistoryQuery orderByOpportunityStageId($order = Criteria::ASC) Order by the opportunity_stage_id column
 ...
 * @method     ChildOpportunityHistoryQuery groupByUserAccountId() Group by the user_account_id column
 * @method     ChildOpportunityHistoryQuery groupByOpportunityStageId() Group by the opportunity_stage_id column
 ...
 * @method     ChildOpportunityHistory findOneByUserAccountId(int $user_account_id) Return the first ChildOpportunityHistory filtered by the user_account_id column
 ...
 * @method     ChildOpportunityHistory requireOneByUserAccountId(int $user_account_id) Return the first ChildOpportunityHistory filtered by the user_account_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOpportunityHistory requireOneByOpportunityStageId(int $opportunity_stage_id) Return the first ChildOpportunityHistory filtered by the opportunity_stage_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildOpportunityHistory[]|ObjectCollection findByUserAccountId(int $user_account_id) Return ChildOpportunityHistory objects filtered by the user_account_id column
 * @method     ChildOpportunityHistory[]|ObjectCollection findByOpportunityStageId(int $opportunity_stage_id) Return ChildOpportunityHistory objects filtered by the opportunity_stage_id column
...
abstract class OpportunityHistoryQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query on the user_account_id column
     *
     * Example usage:
     * <code>
     * $query->filterByUserAccountId(1234); // WHERE user_account_id = 1234
     * $query->filterByUserAccountId(array(12, 34)); // WHERE user_account_id IN (12, 34)
     * $query->filterByUserAccountId(array('min' => 12)); // WHERE user_account_id > 12
     * </code>
     *
     * @param     mixed $userAccountId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildOpportunityHistoryQuery The current query, for fluid interface
     */
    public function filterByUserAccountId($userAccountId = null, $comparison = null)
    {
        if (is_array($userAccountId)) {
            $useMinMax = false;
            if (isset($userAccountId['min'])) {
                $this->addUsingAlias(OpportunityHistoryTableMap::COL_USER_ACCOUNT_ID, $userAccountId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userAccountId['max'])) {
                $this->addUsingAlias(OpportunityHistoryTableMap::COL_USER_ACCOUNT_ID, $userAccountId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OpportunityHistoryTableMap::COL_USER_ACCOUNT_ID, $userAccountId, $comparison);
    }

    /**
     * Filter the query on the opportunity_stage_id column
     *
     * Example usage:
     * <code>
     * $query->filterByOpportunityStageId(1234); // WHERE opportunity_stage_id = 1234
     * $query->filterByOpportunityStageId(array(12, 34)); // WHERE opportunity_stage_id IN (12, 34)
     * $query->filterByOpportunityStageId(array('min' => 12)); // WHERE opportunity_stage_id > 12
     * </code>
     *
     * @param     mixed $opportunityStageId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildOpportunityHistoryQuery The current query, for fluid interface
     */
    public function filterByOpportunityStageId($opportunityStageId = null, $comparison = null)
    {
        if (is_array($opportunityStageId)) {
            $useMinMax = false;
            if (isset($opportunityStageId['min'])) {
                $this->addUsingAlias(OpportunityHistoryTableMap::COL_OPPORTUNITY_STAGE_ID, $opportunityStageId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($opportunityStageId['max'])) {
                $this->addUsingAlias(OpportunityHistoryTableMap::COL_OPPORTUNITY_STAGE_ID, $opportunityStageId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OpportunityHistoryTableMap::COL_OPPORTUNITY_STAGE_ID, $opportunityStageId, $comparison);
    }

    /**
     * Filter the query on the buyer_stage_id column
     *
     * Example usage:
     * <code>
     * $query->filterByBuyerStageId(1234); // WHERE buyer_stage_id = 1234
     * $query->filterByBuyerStageId(array(12, 34)); // WHERE buyer_stage_id IN (12, 34)
     * $query->filterByBuyerStageId(array('min' => 12)); // WHERE buyer_stage_id > 12
     * </code>
     *
     * @param     mixed $buyerStageId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildOpportunityHistoryQuery The current query, for fluid interface
     */
    public function filterByBuyerStageId($buyerStageId = null, $comparison = null)
    {
        if (is_array($buyerStageId)) {
            $useMinMax = false;
            if (isset($buyerStageId['min'])) {
                $this->addUsingAlias(OpportunityHistoryTableMap::COL_BUYER_STAGE_ID, $buyerStageId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($buyerStageId['max'])) {
                $this->addUsingAlias(OpportunityHistoryTableMap::COL_BUYER_STAGE_ID, $buyerStageId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OpportunityHistoryTableMap::COL_BUYER_STAGE_ID, $buyerStageId, $comparison);
    }
