...
class AccountTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'EmailDomain', 'Website', 'SfdcAccountId', 'ClientId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'emailDomain', 'website', 'sfdcAccountId', 'clientId', ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID, AccountTableMap::COL_NAME, AccountTableMap::COL_EMAIL_DOMAIN, AccountTableMap::COL_WEBSITE, AccountTableMap::COL_SFDC_ACCOUNT_ID, AccountTableMap::COL_CLIENT_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email_domain', 'website', 'sfdc_account_id', 'client_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'EmailDomain' => 2, 'Website' => 3, 'SfdcAccountId' => 4, 'ClientId' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'emailDomain' => 2, 'website' => 3, 'sfdcAccountId' => 4, 'clientId' => 5, ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID => 0, AccountTableMap::COL_NAME => 1, AccountTableMap::COL_EMAIL_DOMAIN => 2, AccountTableMap::COL_WEBSITE => 3, AccountTableMap::COL_SFDC_ACCOUNT_ID => 4, AccountTableMap::COL_CLIENT_ID => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email_domain' => 2, 'website' => 3, 'sfdc_account_id' => 4, 'client_id' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
