...
class BuyerStageTableMap extends TableMap
{
     ...
     */
    const COL_CREATED_AT = 'buyer_stage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'buyer_stage.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(BuyerStageTableMap::COL_ID, BuyerStageTableMap::COL_CLIENT_ID, BuyerStageTableMap::COL_STAGE, BuyerStageTableMap::COL_CREATED_AT, BuyerStageTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(BuyerStageTableMap::COL_ID => 0, BuyerStageTableMap::COL_CLIENT_ID => 1, BuyerStageTableMap::COL_STAGE => 2, BuyerStageTableMap::COL_CREATED_AT => 3, BuyerStageTableMap::COL_UPDATED_AT => 4, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BuyerStageTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(BuyerStageTableMap::COL_UPDATED_AT);
        } else {
